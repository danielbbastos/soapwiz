...
/// Shared container and fully-connected fixture for the backup suites.
@MainActor
protocol BackupTestHelpers {}

extension BackupTestHelpers {
    ...
    @discardableResult
    func seedFullGraph(_ ctx: ModelContext) -> UUID {
    ...
    func makeOil(_ ctx: ModelContext, category: IngredientCategory) -> Ingredient {
    ...
    func makeRecipe(_ ctx: ModelContext, oil: Ingredient) -> Recipe {
    ...
    func roundTripInPlace(_ ctx: ModelContext) throws {
